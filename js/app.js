...
window.app.navigate = (viewName) => {
  ...
  switch (viewName) {
    ...
    case "orders":
      ...
      break;
    case "library": // --- NEW CASE ---
      if (window.app.renderLibrary) window.app.renderLibrary();
      break;
    case "admin":
...
window.app.updateNav = () => {
  ...
  if (!window.DB.currentUser) {
    ...
    let html = `
            ...
            <div class="nav-item" onclick="window.app.navigate('library')"><i class="fas fa-gamepad"></i> Library</div> <!-- NEW LINK -->
